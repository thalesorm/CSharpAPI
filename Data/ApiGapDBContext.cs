...
{
    public partial class ApiGapDBContext : DbContext
    {
        public ApiGapDBContext(DbContextOptions<ApiGapDBContext> options)
            : base(options)
        {
        }

        public ApiGapDBContext()
        {
